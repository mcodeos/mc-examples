...
```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode 02-power/201-battery-input.mc
```

Generate HTML for `201-battery-input.mc`:

```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode --viz 02-power/201-battery-input.mc -o 02-power/201-battery-input.html
```
...
```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode 02-power/202-usb-5v-input.mc
```

Generate HTML for `202-usb-5v-input.mc`:

```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode --viz 02-power/202-usb-5v-input.mc -o 02-power/202-usb-5v-input.html
```
...
```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode 02-power/203-ldo-5v-to-3v3.mc
```

Generate HTML for `203-ldo-5v-to-3v3.mc`:

```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode --viz 02-power/203-ldo-5v-to-3v3.mc -o 02-power/203-ldo-5v-to-3v3.html
```
...
```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode 02-power/204-buck-12v-to-5v.mc
```

Generate HTML for `204-buck-12v-to-5v.mc`:

```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode --viz 02-power/204-buck-12v-to-5v.mc -o 02-power/204-buck-12v-to-5v.html
```
...
```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode 02-power/205-power-tree-5v-3v3-1v8.mc
```

Generate HTML for `205-power-tree-5v-3v3-1v8.mc`:

```bash
MCC_SYSTEM_ROOT="$(cd .. && pwd)" ../mcc/target/debug/mcc parse --lib mcode --viz 02-power/205-power-tree-5v-3v3-1v8.mc -o 02-power/205-power-tree-5v-3v3-1v8.html
```
